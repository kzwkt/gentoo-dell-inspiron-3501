...
static const char *upbright[] = { "light", "-U", "5", NULL };
static const char *downbright[] = { "light", "-A", "5", NULL };
...
static const char *caretinstantswitchcmd[] = {"rofi", "-show", "window", "-kb-row-down", "Alt+Tab,Down", "-kb-row-up", "Alt+Ctrl+Tab,Up", "-kb-accept-entry", "!Alt_L,!Alt+Tab,Return", "-me-select-entry", "", "-me-accept-entry", "MousePrimary", "-theme", "/home/kai/.config/rofi/appmenu.rasi", NULL};
...
static const char *rangercmd[] = { "st","-e","nnn", NULL };
...
static const char  *editorcmd[] = { "nano", NULL };
...
static const char *mount[]={"imnt",NULL};
static const char *umount[]={"imnt",NULL};
...
static Key keys[] = {
	...
	{MODKEY,                                XK_z, 	   			spawn,				  {.v = mount} },
	{MODKEY|ShiftMask,                      XK_z, 				spawn,  			  {.v = umount} },
